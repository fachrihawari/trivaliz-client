...
export const timerAtom = atomWithStorage<number>('timer', 10, undefined, { getOnInit: true })
...
export const pickedAnswersAtom = atomWithStorage<string[]>('pickedAnswers', [], undefined, { getOnInit: true })
